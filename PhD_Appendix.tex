...
\noindent where both $N_i$ and \textit{H}* are constants and $H_i$ is the random variable of interest. 

Now, differentiating the above expression with respect to $H_i$ and factoring the \\ denominator leads to
...
\begin{equation}
\widehat{Var}[N^*_{i+1}] = [g'(H_i)]^2\hat{\sigma}^2_{H_i} = \left(\frac{N^*_{i+1}}{H_i}\right)^2\hat{\sigma}^2_{H_i}.
\end{equation}
